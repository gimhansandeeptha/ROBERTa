...
class ModelPrediction:
    def __init__(self) -> None:
        print("change metadata path to : metadata\\roberta.json src.inference.main")
        self.roberta_app = App(metadata_path = "metadata\\state_dict.json")
    ...
    def get_sentiments(self, sentiment_data: SentimentData):
